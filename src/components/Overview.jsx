...
export default function Overview({ overview, isDark }) {
    return (
        <li
            className={`flex items-center justify-between list-none w-full p-6 rounded-md ${isDark ? "bg-dark-card-bg" : "bg-light-card-bg"}`}
        >
            <div className="flex flex-col justify-between gap-6">
                <p className={`text-sm font-fw-bold ${isDark ? "text-dark-txt-1" : "text-light-txt-1" }`}>
                    {overview.heading}
                </p>
                <p
